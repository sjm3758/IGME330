...
#pragma region Accessors
	...
	*/
	...
	/*
	Usage: Returns a vector projected along an axis
	Arguments: axis - the axis to project on
		   point - the vector projected on the axis
	Output: the resulting projection on the axis
	*/
	vector3 ProjectPoint(vector3 axis, vector3 point);
